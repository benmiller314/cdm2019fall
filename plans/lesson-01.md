...
* **For next time**:
 1. **Read** [syllabus and grading contract](/{{site.course.base_url}}uploads), which you can download on the Uploads page of the site. Print and either initial-and-sign the contract, or come back with suggested changes. (But bear in mind that all bargaining over the contract must be collective – we have to achieve consensus on any revisions.)
